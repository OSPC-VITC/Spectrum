...
export const ContainerScroll = ({
  ...
  return (
    ...
    >
      ...
      >
        <Header translate={useTransform(scrollYProgress, [0, 0.5], [0, -50])} titleComponent={titleComponent} />
        <Card rotate={rotate} translate={useTransform(scrollYProgress, [0, 0.5], [0, -50])} scale={scale} mobileHeight={mobileHeight}>
          {children}
        </Card>
      </div>
    </div>
